...
class TweetyNet(nn.Module):
    def __init__(self,
        ...
        channels_out, freqbins_out = tmp_out.shape[1], tmp_out.shape[3]
        ...
        self.fc = nn.Linear(2 * self.num_rnn_features, num_classes)
    ...
    def forward(self, x):
        ...
        # so dimension order is (batch, num time bins, num_rnn_features)
