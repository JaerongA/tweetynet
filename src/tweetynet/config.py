...
class TweetyNetConfig:
    ...
    pool1_size = attr.ib(converter=str2tuple, validator=two_element_tuple, default=(8, 1))
    pool1_stride = attr.ib(converter=str2tuple, validator=two_element_tuple, default=(8, 1))
    pool2_size = attr.ib(converter=str2tuple, validator=two_element_tuple, default=(8, 1))
    pool2_stride = attr.ib(converter=str2tuple, validator=two_element_tuple, default=(8, 1))
